                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <a type="button" data-toggle="modal" data-target="#modalEdit"  >
                                    <img src="{{ asset('storage/'. $award->thumbnail_photo) }}" alt="" width="50%" height="50%">
                                </a>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="owl-carousel owl-theme">                                
                                ...
                                <div class="item">                                              
                                    <a type="button" data-toggle="modal" data-target="#modalEdit{{$item->id}}"  >
                                        <img src="{{ asset('storage/' . $item->photo_award) }}" alt="" height="300px" width="300px">                                                                                                                
                                    </a>                                    
                                </div>                                
                                @endforeach                            
                            </div>
...
<div class="modal fade bd-example-modal-lg" id="modalEdit{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="card-body">
                <img src="{{ asset('storage/'. $item->photo_award) }}" alt="" width="100%" height="100%">
            </div>                  
        </div>
    </div>
</div> 
